      ...
      <div className="max-w-7xl mx-auto my-20 justify-center items-center  px-5 flex flex-col gap-10">
        <div className="grid lg:grid-cols-4   justify-center md:grid-cols-3 gap-10 sm:grid-cols-2 grid-cols-1">
          ...
          <ProductCategoryCard
            ...
            days="5 Night / 6 Days"
            productLink={"/product/srinagar/Srinagar03NPahalagm01NHouseboat01N"}
          />
          <ProductCategoryCard
            url="https://images.unsplash.com/photo-1632231065530-f5fd55c62846?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjB8fGthc2htaXJ8ZW58MHx8MHx8fDA%3D"
            ...
            days="5 Night / 6 Days"
            productLink={
              "/product/srinagar/Srinagar02NPahalgam01NGulmarg01NHouseboat01N"
            }
          />
          <ProductCategoryCard
            ...
            days="5 Night / 6 Days"
            productLink={"/product/srinagar/Srinagar03NPahalgam02N"}
          />
          <ProductCategoryCard
            ...
            days="5 Night / 6 Days"
            productLink={
              "/product/srinagar/Srinagar03NPahalgam01NHouseboat01NS"
            }
          />
          <ProductCategoryCard
            ...
            days="6 Night / 7 Days"
            productLink={"/product/srinagar/Srinagar04NPahalgam01NHouseboat01"}
          />
          <ProductCategoryCard
            ...
            days="6 Night / 7 Days"
            productLink={
              "/product/srinagar/Srinagar02NPahalgam02NHouseboat01NGulmarg01N"
            }
          />
          <ProductCategoryCard
            ...
            days="6 Night / 7 Days"
            productLink={"/product/srinagar/Srinagar03NPahalgam02NHouseboat01N"}
          />
          <ProductCategoryCard
            ...
            days="6 Night / 7 Days"
            productLink={"/product/srinagar/Srinagar04NPahalagam02N"}
          />
          <ProductCategoryCard
            ...
            days="7 Night / 8 Days"
            productLink={
              "/product/katra/Katra02NSrinagar03NPahalgam01NHouseboat01N"
            }
          />
          <ProductCategoryCard
            ...
            days="7 Night / 8 Days"
            productLink={
              "/product/srinagar/Srinagar02NGulmarg02NPahalgam02NHouseboat01N"
            }
          />
          <ProductCategoryCard
            ...
            days="7 Night / 8 Days"
            productLink={
              "/product/srinagar/Srinagar03NGulmarg01NPahalgam02NHouseboat01N"
            }
          />
          <ProductCategoryCard
            ...
            days="8 Night / 9 Days"
            productLink={
              "/product/srinagar/Srinagar03NPahalgam01NHouseboat01NKatra03N"
            }
          />
          <ProductCategoryCard
            ...
            days="8 Night / 9 Days"
            productLink={
              "/product/katra/Katra02NSrinagar03NHouseboat01NPahalgam02N"
            }
          />
          <ProductCategoryCard
            ...
            productLink={
              "/product/srinagar/Srinagar03NHouseboat01NGulmarg01NPahalgam02NKatra02N"
            }
          />
        </div>
      </div>
