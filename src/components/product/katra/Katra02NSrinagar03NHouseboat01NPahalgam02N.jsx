...
const Katra02NSrinagar03NHouseboat01NPahalgam02N = () => {
          ...
          <div>
            {Array.isArray(destinations) && destinations.length > 0 && (
              <section
                ...
                key={destinations[17]._id}
              >
                <div className="mt-20 px-5 py-16 bg-[#F2FBFA]">
                  <SwiperProductCarousel
                    carouselImageUrl={destinations[17].carouselImageUrl}
                  />
                    ...
                    <div className=" flex sm:justify-between gap-5 justify-start sm:flex-row flex-col sm:items-center   px-5">
                      <div className="flex flex-col gap-5">
                        <h1 className="md:text-4xl text-2xl font-semibold">
                          {destinations[17].heading}
                        </h1>

                        <div className="flex justify-between">
                          <div className="flex gap-2 items-center ">
                            <CiLocationOn size={25} color="#00bb98" />
                            <p>{destinations[17].subHeading}</p>
                ...
                <div className="flex max-w-7xl lg:flex-row flex-col-reverse gap-10 px-5 mx-auto">
                  <ProductDetailLeft
                    overview={destinations[17].overview}
                    overView={destinations[17].overView}
                    mapSrc={destinations[17].mapSrc}
                    reviewHeading={destinations[17].reviewHeading}
                    reviews={destinations[17].reviews}
                    itinerary={destinations[17].itinerary}
                    exclusions={destinations[17].exclusions}
                    inclusions={destinations[17].inclusions}
                    packageOptions={destinations[17].packageOptions}
                  />
                  <ProductRightPricing
                    price={destinations[17].price}
                    previousPrice={destinations[17].previousPrice}
                    openModalFunc={openModalFunc}
                  />
                </div>
...
export default Katra02NSrinagar03NHouseboat01NPahalgam02N;
