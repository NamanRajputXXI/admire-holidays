...
const Srinagar03NGulmarg01NPahalgam02NHouseboat01N = () => {
            ...
            {Array.isArray(destinations) && destinations.length > 0 && (
              ...
              >
                    ...
                    <div className=" flex sm:justify-between gap-5 justify-start sm:flex-row flex-col sm:items-center   px-5">
                      <div className="flex flex-col gap-5">
                        <h1 className="md:text-4xl text-2xl font-semibold">
                          {destinations[15].heading}
                        </h1>

                        <div className="flex justify-between">
                          <div className="flex gap-2 items-center ">
                            <CiLocationOn size={25} color="#00bb98" />
                            <p>{destinations[15].subHeading}</p>
                ...
                <div className="flex max-w-7xl lg:flex-row flex-col-reverse gap-10 px-5 mx-auto">
                  <ProductDetailLeft
                    overview={destinations[15].overview}
                    overView={destinations[15].overView}
                    mapSrc={destinations[15].mapSrc}
                    reviewHeading={destinations[15].reviewHeading}
                    reviews={destinations[15].reviews}
                    itinerary={destinations[15].itinerary}
                    exclusions={destinations[15].exclusions}
                    inclusions={destinations[15].inclusions}
                    packageOptions={destinations[15].packageOptions}
                  />
                  <ProductRightPricing
                    price={destinations[15].price}
                    previousPrice={destinations[15].previousPrice}
                    openModalFunc={openModalFunc}
                  />
                </div>
...
export default Srinagar03NGulmarg01NPahalgam02NHouseboat01N;
