          ...
          <div>
            {Array.isArray(destinations) && destinations.length > 0 && (
              <section
                ...
                key={destinations[12]._id}
              >
                <div className="mt-20 px-5 py-16 bg-[#F2FBFA]">
                  <SwiperProductCarousel
                    carouselImageUrl={destinations[12].carouselImageUrl}
                  />
                    ...
                    <div className=" flex sm:justify-between gap-5 justify-start sm:flex-row flex-col sm:items-center   px-5">
                      <div className="flex flex-col gap-5">
                        <h1 className="md:text-4xl text-2xl font-semibold">
                          {destinations[12].heading}
                        </h1>

                        <div className="flex justify-between">
                          <div className="flex gap-2 items-center ">
                            <CiLocationOn size={25} color="#00bb98" />
                            <p>{destinations[12].subHeading}</p>
                ...
                <div className="flex max-w-7xl lg:flex-row flex-col-reverse gap-10 px-5 mx-auto">
                  <ProductDetailLeft
                    overview={destinations[12].overview}
                    overView={destinations[12].overView}
                    mapSrc={destinations[12].mapSrc}
                    reviewHeading={destinations[12].reviewHeading}
                    reviews={destinations[12].reviews}
                    itinerary={destinations[12].itinerary}
                    exclusions={destinations[12].exclusions}
                    inclusions={destinations[12].inclusions}
                    packageOptions={destinations[12].packageOptions}
                  />
                  <ProductRightPricing
                    price={destinations[12].price}
                    previousPrice={destinations[12].previousPrice}
                    openModalFunc={openModalFunc}
                  />
                </div>
...
export default Srinagar04NPahalagam02N;
