              ...
              >
                ...
                <div className="flex max-w-7xl lg:flex-row flex-col-reverse gap-10 px-5 mx-auto">
                  <ProductDetailLeft
                    ...
                    exclusions={destinations[2].exclusions}
                    inclusions={destinations[2].inclusions}
                    packageOptions={destinations[2].packageOptions}
                  />
                  <ProductRightPricing
...
export default Srinagar03NHouseboat01N;
