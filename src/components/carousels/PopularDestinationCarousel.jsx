        ...
        >
          <div className="w-full relative flex items-center justify-center">
            <ButtonBack
              ...
              className="absolute   rounded-md bg-black py-3 px-2 bg-opacity-60 z-30  left-0 ml-8  cursor-pointer"
              id="prev"
            >
              <svg
                width={30}
        ...
        >
          <div className="w-full relative flex items-center justify-center">
            <ButtonBack
              role="button"
              aria-label="slide backward"
              className="absolute z-30   rounded-md bg-black py-3 px-2 bg-opacity-50 left-0 ml-8 focus:outline-none focus:bg-gray-400 focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 cursor-pointer"
              id="prev"
            >
              <svg
                width={30}
