...
const WeekendTripCard = ({ imageUrl, location, about }) => {
  return (
    <div className="flex flex-col shadow-md gap-3 border-1 rounded-2xl  border-gray-200  justify-center">
      <img src={imageUrl} className="h-72 rounded-2xl" alt={location} />
