...
const Footer = () => {
  return (
    <footer className="grid   md:grid-cols-3 grid-cols-1 sm:grid-cols-2 lg:gap-0 gap-16 lg:grid-cols-4 my-36 max-w-7xl  py-2 mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="flex flex-col  sm:items-start  gap-5 items-center ">
