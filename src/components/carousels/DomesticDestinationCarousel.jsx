        ...
        >
          <div className="w-full relative flex items-center justify-center">
            <ButtonBack
              ...
              className="absolute bg-black p-3 bg-opacity-60 z-30  left-0 ml-8  cursor-pointer"
              id="prev"
            >
              <svg
                width={30}
        ...
        >
          <div className="w-full relative flex items-center justify-center">
            <ButtonBack
              role="button"
              aria-label="slide backward"
              className="absolute  bg-black p-3 bg-opacity-60 z-30 left-0 ml-8 focus:outline-none focus:bg-gray-400 focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 cursor-pointer"
              id="prev"
            >
              <svg
                width={30}
