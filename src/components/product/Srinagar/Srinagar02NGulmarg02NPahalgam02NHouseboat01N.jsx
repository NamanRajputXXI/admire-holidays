...
const Srinagar02NGulmarg02NPahalgam02NHouseboat01N = () => {
          ...
          <div>
            {Array.isArray(destinations) && destinations.length > 0 && (
              <section
                ...
                key={destinations[14]._id}
              >
                <div className="mt-20 px-5 py-16 bg-[#F2FBFA]">
                  <SwiperProductCarousel
                    carouselImageUrl={destinations[14].carouselImageUrl}
                  />
                    ...
                    <div className=" flex sm:justify-between gap-5 justify-start sm:flex-row flex-col sm:items-center   px-5">
                      <div className="flex flex-col gap-5">
                        <h1 className="md:text-4xl text-2xl font-semibold">
                          {destinations[14].heading}
                        </h1>

                        <div className="flex justify-between">
                          <div className="flex gap-2 items-center ">
                            <CiLocationOn size={25} color="#00bb98" />
                            <p>{destinations[14].subHeading}</p>
                ...
                <div className="flex max-w-7xl lg:flex-row flex-col-reverse gap-10 px-5 mx-auto">
                  <ProductDetailLeft
                    overview={destinations[14].overview}
                    overView={destinations[14].overView}
                    mapSrc={destinations[14].mapSrc}
                    reviewHeading={destinations[14].reviewHeading}
                    reviews={destinations[14].reviews}
                    itinerary={destinations[14].itinerary}
                    exclusions={destinations[14].exclusions}
                    inclusions={destinations[14].inclusions}
                    packageOptions={destinations[14].packageOptions}
                  />
                  <ProductRightPricing
                    price={destinations[14].price}
                    previousPrice={destinations[14].previousPrice}
                    openModalFunc={openModalFunc}
                  />
                </div>
...
export default Srinagar02NGulmarg02NPahalgam02NHouseboat01N;
