...
const Srinagar03NPahalgam01NHouseboat01N5Nights = () => {
          ...
          <div>
            {Array.isArray(destinations) && destinations.length > 0 && (
              <section
                ...
                key={destinations[5]._id}
              >
                <div className="mt-20 px-5 py-16 bg-[#F2FBFA]">
                  <SwiperProductCarousel
                    carouselImageUrl={destinations[5].carouselImageUrl}
                  />
                    ...
                    <div className=" flex sm:justify-between gap-5 justify-start sm:flex-row flex-col sm:items-center   px-5">
                      <div className="flex flex-col gap-5">
                        <h1 className="md:text-4xl text-2xl font-semibold">
                          {destinations[5].heading}
                        </h1>

                        <div className="flex justify-between">
                          <div className="flex gap-2 items-center ">
                            <CiLocationOn size={25} color="#00bb98" />
                            <p>{destinations[5].subHeading}</p>
                ...
                <div className="flex max-w-7xl lg:flex-row flex-col-reverse gap-10 px-5 mx-auto">
                  <ProductDetailLeft
                    overview={destinations[5].overview}
                    overView={destinations[5].overView}
                    mapSrc={destinations[5].mapSrc}
                    reviewHeading={destinations[5].reviewHeading}
                    reviews={destinations[5].reviews}
                    itinerary={destinations[5].itinerary}
                    exclusions={destinations[5].exclusions}
                    inclusions={destinations[5].inclusions}
                    packageOptions={destinations[5].packageOptions}
                  />
                  <ProductRightPricing
                    price={destinations[5].price}
                    previousPrice={destinations[5].previousPrice}
                    openModalFunc={openModalFunc}
                  />
                </div>
...
export default Srinagar03NPahalgam01NHouseboat01N5Nights;
