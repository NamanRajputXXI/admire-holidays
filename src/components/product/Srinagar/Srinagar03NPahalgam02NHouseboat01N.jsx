...
const Srinagar03NPahalgam02NHouseboat01N = () => {
          ...
          <div>
            {Array.isArray(destinations) && destinations.length > 0 && (
              <section
                ...
                key={destinations[11]._id}
              >
                <div className="mt-20 px-5 py-16 bg-[#F2FBFA]">
                  <SwiperProductCarousel
                    carouselImageUrl={destinations[11].carouselImageUrl}
                  />
                    ...
                    <div className=" flex sm:justify-between gap-5 justify-start sm:flex-row flex-col sm:items-center   px-5">
                      <div className="flex flex-col gap-5">
                        <h1 className="md:text-4xl text-2xl font-semibold">
                          {destinations[11].heading}
                        </h1>

                        <div className="flex justify-between">
                          <div className="flex gap-2 items-center ">
                            <CiLocationOn size={25} color="#00bb98" />
                            <p>{destinations[11].subHeading}</p>
                ...
                <div className="flex max-w-7xl lg:flex-row flex-col-reverse gap-10 px-5 mx-auto">
                  <ProductDetailLeft
                    overview={destinations[11].overview}
                    overView={destinations[11].overView}
                    mapSrc={destinations[11].mapSrc}
                    reviewHeading={destinations[11].reviewHeading}
                    reviews={destinations[11].reviews}
                    itinerary={destinations[11].itinerary}
                    exclusions={destinations[11].exclusions}
                    inclusions={destinations[11].inclusions}
                    packageOptions={destinations[11].packageOptions}
                  />
                  <ProductRightPricing
                    price={destinations[11].price}
                    previousPrice={destinations[11].previousPrice}
                    openModalFunc={openModalFunc}
                  />
                </div>
...
export default Srinagar03NPahalgam02NHouseboat01N;
